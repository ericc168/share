...
md -Path c:\temp\installers -erroraction SilentlyContinue | Out-Null
# Install Chrome
# Define the download URL and the installer
$chromeUrl = "https://dl.google.com/chrome/install/latest/chrome_installer.exe"
$installer = join-path c:\temp\installers chrome_installer.exe
...
$Download = join-path c:\temp\install MicrosoftEdgeEnterpriseX64.msi
